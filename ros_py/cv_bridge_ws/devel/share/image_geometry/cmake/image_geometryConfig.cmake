...
if("TRUE" STREQUAL "TRUE")
  set(image_geometry_SOURCE_PREFIX /home/rpf/cv_bridge_ws/src/vision_opencv/image_geometry)
  set(image_geometry_DEVEL_PREFIX /home/rpf/cv_bridge_ws/devel)
  ...
  set(image_geometry_INSTALL_PREFIX /home/rpf/cv_bridge_ws/install)
...
if(NOT "/home/rpf/cv_bridge_ws/src/vision_opencv/image_geometry/include;/usr/include;/usr/include/opencv " STREQUAL " ")
  set(image_geometry_INCLUDE_DIRS "")
  set(_include_dirs "/home/rpf/cv_bridge_ws/src/vision_opencv/image_geometry/include;/usr/include;/usr/include/opencv")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_geometry' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rpf/cv_bridge_ws/src/vision_opencv/image_geometry/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/rpf/cv_bridge_ws/devel/lib;/home/rpf/rpf_ws/devel/lib;/opt/ros/melodic/lib)
