...
echo_and_run cd "/home/rpf/cv_bridge_ws/src/vision_opencv/cv_bridge"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/rpf/cv_bridge_ws/src/vision_opencv/cv_bridge/setup.py" \
    egg_info --egg-base /home/rpf/cv_bridge_ws/build/vision_opencv/cv_bridge \
    build --build-base "/home/rpf/cv_bridge_ws/build/vision_opencv/cv_bridge" \
    install \
    --root="${DESTDIR-/}" \
